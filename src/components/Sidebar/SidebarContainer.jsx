...
export const SidebarContainer = ({ selectedCourses }) => {
  ...
  return (
    <div className="lg:sticky top-10 right-0 bg-white rounded-lg p-6 h-fit text-left space-y-4 py-10">
      ...
      <hr className="w-full h-[2px] " />
      <h1 className="text-black text-[18px] font-medium">Total Credit Hour:</h1>
      <hr className="w-full h-[2px] " />
      <h1 className="text-black text-[18px] font-medium">Total Price:</h1>
      <hr className="w-full h-[2px] " />
    </div>
  );
};
